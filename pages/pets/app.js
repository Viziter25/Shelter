...
console.log('нужно обновлять страницу при каждом изменении ширины экрана(1280; 768; 320');
...
const sliderEnd = document.querySelector('.slider__end');
...
sliderNumber.innerHTML = '1';

const pageCounter = Math.ceil(PETS.length/notesOnPage);
...
sliderNext.addEventListener('click', () => {
    if (+sliderNumber.innerText < pageCounter) {
        sliderNumber.innerText = +sliderNumber.innerText + 1;
        showPage(sliderNumber.innerText);
      
        sliderBack.classList.add('active');
        sliderfirst.classList.add('active');

        if (+sliderNumber.innerText == pageCounter){
        sliderNext.classList.add('disabled');
        sliderEnd.classList.add('disabled');
        }
    }
});

sliderBack.addEventListener('click', () => {
    if (+sliderNumber.innerText > 1) {
        sliderNumber.innerText = +sliderNumber.innerText -1;
        showPage(sliderNumber.innerText);
        
        sliderNext.classList.remove('disabled');
        sliderEnd.classList.remove('disabled');

        if (+sliderNumber.innerText == 1){
        sliderBack.classList.remove('active');
...
sliderEnd.addEventListener('click', () => {
    sliderNumber.innerText = pageCounter;
    showPage(sliderNumber.innerText);
    disablePagination();
});

sliderfirst.addEventListener('click', () => {
    sliderNumber.innerText = 1;
    showPage(sliderNumber.innerText);
